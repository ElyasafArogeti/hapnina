...
useEffect(() => {
  const fetchImages = async () => {
    ...
    try {
      const response = await axios.get('http://hapnina-b1d08178cec4.herokuapp.com/getUploadedImages',{
        headers: {
  ...
  const handleUpload = async () => {
    ...
    try {
      const response = await axios.post('http://hapnina-b1d08178cec4.herokuapp.com/uploadImage', formData, {
        headers: { 
  ...
  const handleDeleteImage = async (public_id) => {
    try {
      ...
      const response = await axios.delete(`http://hapnina-b1d08178cec4.herokuapp.com/deleteImage/${encodedPublicId}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        }
      });
  ...
  const handleUpdateImage = async () => {
    ...
    try {
      const response = await axios.put(`http://hapnina-b1d08178cec4.herokuapp.com/updateImage/${editingImage.public_id}`, { name: imageName });
