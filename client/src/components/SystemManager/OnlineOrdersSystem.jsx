...
const OnlineOrdersSystem = () => {
  ...
  useEffect(() => {
    ...
    try {
      ...
      const response = await fetch('http://hapnina-b1d08178cec4.herokuapp.com/online_orders', {
          method: 'GET',
          headers: {
  ...
  const handleAddCustomerOrder = async (orderId) => {
    try {
      ...
      const response = await fetch('http://hapnina-b1d08178cec4.herokuapp.com/online_orders/add_customer_order', {
        method: 'POST',
        headers: {
      ...
      if (response.ok) {
        ...
        const deleteResponse = await fetch(`http://hapnina-b1d08178cec4.herokuapp.com/online_orders/${orderId}`, {
          method: 'DELETE',
          headers: {
            'Authorization': `Bearer ${token}`,
          }
  ...
  const handleDeleteOrder = async (orderId) => {
    ...
    try {
      const token = localStorage.getItem("authToken");
      const response = await fetch(`http://hapnina-b1d08178cec4.herokuapp.com/online_orders/${orderId}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${token}`,
        }
